...
internal sealed class MQTTSubscriptionsManager
{
    ...
    public async ValueTask<SubscribeResult> SubscribeAsync(MQTTSubscribePackage subscribePacket, CancellationToken cancellationToken)
    {

    }

    public async ValueTask<UnsubscribeResult> UnsubscribeAsync(MQTTUnsubscribePackage unsubscribePacket, CancellationToken cancellationToken)
    {
    }
